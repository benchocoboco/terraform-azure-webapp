<%@ Page language="c#" Codebehind="MerciDownload.aspx.cs" AutoEventWireup="false" Inherits="Proverbes.net.MerciDownload" %>
		...
		<form id="Accueil" method="post" runat="server">
			...
			<table style="BORDER-COLLAPSE: collapse" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td vAlign="top">
						<P><br>
							Votre demande a été prise en compte et un message a été envoyé&nbsp;à votre 
							adresse avec l'URL de téléchargement. Merci de l'intérêt que vous portez à ce 
							site.</P>
						<a href="Accueil.aspx">Retour à l'accueil</a>
						<P>&nbsp;</P>
					</td>
				</tr>
			</table>
