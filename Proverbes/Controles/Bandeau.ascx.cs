...
namespace Proverbes.net
{
	...
	/// </summary>
	/// <remarks>
	/// - La propriété "Titre" représente le titre à afficher
	/// - La propriété "background" correspond à l'image de fond
	/// - Le titre est affiché avec le style CSS "BandeauTitre"
	/// </remarks>
